                ...
                <form action="#">
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-6 col-xl-7">
                            ...
                            <div class="form-item">
                                <label class="form-label my-3">Mã bưu<sup>*</sup></label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="form-item">
                            ...
                            <div class="form-check my-3">
                                ...
                                <label class="form-check-label" for="Address-1">Đã có tài khoản ?</label>
                            </div>
                            <div class="form-item">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="img/anhthuoc1.webp" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="img/anhthuoc2.webp" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                            <td class="py-5">Viên uống Glucosamine</td>
                                            <td class="py-5">768.000đ/hộp</td>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="img/anhthuoc3.webp" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                            <td class="py-5">Viên uống Glucosamine</td>
                                            <td class="py-5">768.000đ/hộp</td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="py-5">
                                                ...
                                                <div class="form-check text-start">
                                                    ...
                                                    <label class="form-check-label" for="Shipping-2">Mã đã áp dụng: $15.00</label>
                                                </div>
                                                <div class="form-check text-start">
                                                    <input type="checkbox" class="form-check-input bg-primary border-0" id="Shipping-3" name="Shipping-1" value="Shipping">
                                                    <label class="form-check-label" for="Shipping-3">Tổng số tiền : $8.00</label>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
