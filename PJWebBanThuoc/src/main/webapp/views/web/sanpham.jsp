						...
						<div id="carouselExampleIndicators" class="carousel slide"
							...
							<div class="carousel-inner rounded-1">
								<div class="carousel-item active">
									<img src="img/AnhCara2.PNG" class="img-fluid d-block" alt=""
										style="height: 200px;">
								</div>
								<div class="carousel-item">
									<img src="img/AnhCara1.PNG" class="img-fluid d-block w-100"
										alt="" style="height: 200px;">
								</div>
								<div class="carousel-item">
									<img src="img/AnhCara3.PNG" class="img-fluid d-block w-100"
										alt="" style="height: 200px;">
								</div>
							</div>
